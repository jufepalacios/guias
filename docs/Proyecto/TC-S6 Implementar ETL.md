...
- Infraestructura Visible está de acuerdo en que hay varios nombres para algunos departamentos, y acoge la propuesta de estandarizar los datos, transformación que será responsabilidad de ustedes
...
- Les solicitan que corrijan los valores negativos de numero_vuelos_origen, multiplicando por -1
