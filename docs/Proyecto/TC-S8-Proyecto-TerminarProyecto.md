...
●	Datos compartidos en la base de datos **Proyecto_DWH_solucion**, que corresponden a las tablas que representan el modelo dimensional compartido por InfraestructuraVisible como solución, el cual se presenta en la imagen que se presenta más adelante.
