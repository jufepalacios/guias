...
1.	***Entregable 1: Tableros de control.*** Deben construir dos tableros de control para resolver los requerimientos analíticos solicitados por Infraestructura Visible. Los tableros deben conectarse a la base de datos que toma el rol de bodega de datos. Para validar los tableros deben enviar el enlace con la configuración habilitada para edición
