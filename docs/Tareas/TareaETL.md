...
1. Diseñe el ETL para las dimensiones proveedor, tipoTransaccion y para la tabla de hechos
2. Implemente el ETL diseñado para las dimensiones Proveedor, TipoTransaccion y para la tabla de hechos
